                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" v-on:submit.prevent="grabarNuevo()">
                            ...
                            <Select title="Rol:" v-model="cuenta.rol_id" :error="errors.rol_id">
                                <option value="" disabled>- Seleccionar Rol -</option>
                                <option v-for="rol in roles" :value="rol.id">{{ rol.nombre_rol }}</option>
                            </Select>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" v-on:submit.prevent="grabarEditar()">
                            ...
                            <Select title="Rol:" v-model="cuenta_editar.rol_id">
                                <option value="" disabled>- Seleccionar Rol -</option>
                                <option v-for="rol in roles" :value="rol.id">{{ rol.nombre_rol }}</option>
                            </Select>
                            <div class="text-center">
...
export default {
    ...
    methods: {
        ...
        listarRol(){
            axios.get(url_base+'/rol?all=true')
            .then(response => {
