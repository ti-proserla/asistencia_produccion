...
export default {
    ...
    computed: {
        url(){
            return url_base+'/v2/rpt/rango?fecha_inicio='+this.consulta.fecha_inicio+'&fecha_fin='+this.consulta.fecha_fin+'&planilla_id='+this.consulta.planilla_id+'&turno='+this.consulta.turno+'&excel';
        }
    },
    mounted() {
        this.listarPlanilla();
    ...
    methods: {
        listar(n=this.selectPage){
            this.selectPage=n;
            axios.get(url_base+'/v2/rpt/rango?fecha_inicio='+this.consulta.fecha_inicio+'&fecha_fin='+this.consulta.fecha_fin+'&search='+this.search+'&planilla_id='+this.consulta.planilla_id+'&fundo_id='+this.consulta.fundo_id+'&turno='+this.consulta.turno+'&page='+n)
            .then(response => {
