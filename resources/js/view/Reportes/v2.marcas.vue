...
export default {
    ...
    computed: {
        url(){
            return url_base+'/v2/reporte-marcas?turno='+this.turno+'&fecha='+this.fecha+'&planilla_id='+this.planilla_id+'&excel';
        },
        urlNisira(){
            return url_base+'/v2/reporte-marcas?turno='+this.turno+'&fecha='+this.fecha+'&planilla_id='+this.planilla_id+'&excel=nisira';
        }
    },
    methods: {
        ...
        listar(n=this.selectPage){
            this.selectPage=n;
            axios.get(url_base+'/v2/reporte-marcas?turno='+this.turno+'&fecha='+this.fecha+'&search='+this.search+'&planilla_id='+this.planilla_id+'&page='+n)
            .then(response => {
