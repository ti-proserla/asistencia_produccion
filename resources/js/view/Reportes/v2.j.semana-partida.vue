...
export default {
    ...
    computed: {
        url(){
            return url_base+'/v2/reporte-semana-partida?inicio='+this.periodo_inicio+'&fin='+this.periodo_fin+'&planilla_id='+this.consulta.planilla_id+'&turno='+this.consulta.turno+'&excel';
        },
        periodoPorAnio(){            
    ...
    methods: {
        ...
        listar(n=this.selectPage){
            this.selectPage=n;
            axios.get(url_base+'/v2/reporte-semana-partida?inicio='+this.periodo_inicio+'&fin='+this.periodo_fin+'&search='+this.search+'&planilla_id='+this.consulta.planilla_id+'&fundo_id='+this.consulta.fundo_id+'&turno='+this.consulta.turno+'&page='+n)
            .then(response => {
