...
export default {
    ...
    computed: {
        url(){
            return url_base+'/rpt/horas_nocturnas?year='+this.consulta.year+'&week='+this.consulta.week+'&planilla_id='+this.consulta.planilla_id+'&excel';
        }
    },
    mounted() {
        this.listarPlanilla();
    ...
    methods: {
        listar(n=this.selectPage){
            this.selectPage=n;
            axios.get(url_base+'/rpt/horas_nocturnas?year='+this.consulta.year+'&week='+this.consulta.week+'&search='+this.search+'&planilla_id='+this.consulta.planilla_id+'&fundo_id='+this.consulta.fundo_id+'&page='+n)
            .then(response => {
